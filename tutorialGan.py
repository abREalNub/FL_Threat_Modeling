...
dataset = MNIST(root='.', train=True, download=False, transform=transforms.Compose([transforms.Resize((28, 28)),
                                                                                    transforms.ToTensor(),
...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        if (iters % 500 == 0) or ((epoch == num_epochs - 1) and (i == len(dataloader) - 1)):
            ...
            vutils.save_image(img_grid, f"generated_images/epoch_{epoch}_iter_{i}.png")
